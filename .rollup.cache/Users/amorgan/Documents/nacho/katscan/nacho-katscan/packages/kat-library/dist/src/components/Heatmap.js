...
function Heatmap({ width, height, type = 'circle', events = false, hover = false, borderOnHover = false, margin = defaultMargin, separation = 20, }) {
    ...
    xScale.range([0, xMax]);
    yScale.range([yMax, 0]);
    return width < 10 ? null : (_jsxs("svg", { width: width, height: height, children: [_jsx("rect", { x: 0, y: 0, width: width, height: height, rx: 14, fill: background }), _jsx(Group, { top: margin.top, left: margin.left, children: type === 'circle' ? (_jsx(HeatmapCircle, { data: binData, xScale: (d) => { var _a; return (_a = xScale(d)) !== null && _a !== void 0 ? _a : 0; }, yScale: (d) => { var _a; return (_a = yScale(d)) !== null && _a !== void 0 ? _a : 0; }, colorScale: circleColorScale, opacityScale: opacityScale, radius: radius, gap: 2, children: (heatmap) => heatmap.map((heatmapBins) => heatmapBins.map((bin) => (_jsx("circle", { className: "visx-heatmap-circle", cx: bin.cx, cy: bin.cy, r: bin.r, fill: bin.color, fillOpacity: bin.opacity, stroke: borderOnHover && (tooltipData === null || tooltipData === void 0 ? void 0 : tooltipData.row) === bin.row && (tooltipData === null || tooltipData === void 0 ? void 0 : tooltipData.column) === bin.column ? 'black' : 'none', strokeWidth: borderOnHover ? 2 : 0, onMouseEnter: () => hover && setTooltipData({ row: bin.row, column: bin.column }), onMouseLeave: () => hover && setTooltipData(null), onClick: () => {
                            if (!events)
                                return;
                            alert(JSON.stringify({ row: bin.row, column: bin.column, bin: bin.bin }));
                        } }, `heatmap-circle-${bin.row}-${bin.column}`)))) })) : (_jsx(HeatmapRect, { data: binData, xScale: (d) => { var _a; return (_a = xScale(d)) !== null && _a !== void 0 ? _a : 0; }, yScale: (d) => { var _a; return (_a = yScale(d)) !== null && _a !== void 0 ? _a : 0; }, colorScale: rectColorScale, opacityScale: opacityScale, binWidth: binWidth, binHeight: binWidth, gap: 2, children: (heatmap) => heatmap.map((heatmapBins) => heatmapBins.map((bin) => (_jsx("rect", { className: "visx-heatmap-rect", width: bin.width, height: bin.height, x: bin.x, y: bin.y, fill: bin.color, fillOpacity: bin.opacity, stroke: borderOnHover && (tooltipData === null || tooltipData === void 0 ? void 0 : tooltipData.row) === bin.row && (tooltipData === null || tooltipData === void 0 ? void 0 : tooltipData.column) === bin.column ? 'black' : 'none', strokeWidth: borderOnHover ? 2 : 0, onMouseEnter: () => hover && setTooltipData({ row: bin.row, column: bin.column }), onMouseLeave: () => hover && setTooltipData(null), onClick: () => {
                            if (!events)
                                return;
                            alert(JSON.stringify({ row: bin.row, column: bin.column, bin: bin.bin }));
                        } }, `heatmap-rect-${bin.row}-${bin.column}`)))) })) })] }));
}
