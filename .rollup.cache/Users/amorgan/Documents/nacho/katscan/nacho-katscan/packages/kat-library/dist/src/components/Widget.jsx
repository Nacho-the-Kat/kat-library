...
const Widget = ({ value, icon, onClick }) => {
    ...
    return (<div className={`flex items-center flex-col col-span-full sm:col-span-4 xl:col-span-2 bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-gray-100 dark:border-gray-700/60 transition-colors duration-300 ease-in-out ${onClick ? 'cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-900' : ''}`} onClick={onClick ? handleClick : undefined}>
